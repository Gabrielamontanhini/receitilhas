...
export function Detail() {
    ...
    }, [navigation, route.params?.data, favorited])
    ...
    async function handleFavoriteRecipe(recipe){
     console.log("cricou") 
       if(favorited){
            ...
            await saveFavorite("@receitilhas", recipe)
            setFavorited(true)
        }
    }
    ...
    async function shareRecipe(){
        try{
            await Share.share({
                ...
                Com ${route.params?.data.total_ingredients} ingredientes. \n
                Vi no App receitilhas!`
            })
        }catch(err){
            console.log(err)
        }
